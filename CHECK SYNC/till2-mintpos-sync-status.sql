-- Till 2 MintPOS sync status (read-only)
-- Run in SSMS on the Till 2 PC against database MINTPOS.
--
-- Compare with: node firestore-count.cjs a655b0a1-a37a-43d6-aa55-7f97377b2660
-- Fully synced when:
--   pending_bills = 0
...
BEGIN
  SELECT TOP 20
    ...
    s.time AS sale_time,
    s.uploadstatus,
    CONCAT('a655b0a1-a37a-43d6-aa55-7f97377b2660-', bt.id) AS expected_firestore_doc_id
