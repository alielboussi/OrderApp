export type DamageWhatsAppLine = {
  name: string;
  qty: number;
};

export type ApprovedDamageWhatsAppInput = {
  outletName: string;
  reportedAt: string;
  reportNumber: string;
  reportedByName: string;
  supervisorName: string;
  lines: DamageWhatsAppLine[];
};
...
export function formatApprovedDamageWhatsAppMessage(input: ApprovedDamageWhatsAppInput): string {
