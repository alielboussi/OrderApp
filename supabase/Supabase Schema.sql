[
  {
    "schema_export": {
      ...
      "indexes": [
        ...
        {
          "indexdef": "CREATE UNIQUE INDEX idx_catalog_items_name_item_kind_unique ON public.catalog_items USING btree (lower(name), item_kind)",
          "indexname": "idx_catalog_items_name_item_kind_unique",
          "table_name": "catalog_items",
          "table_schema": "public"
        },
        {
      ...
      "functions": [
        ...
        {
          "arguments": "p_outlet_id uuid, p_source_event_id text",
          "definition": "CREATE OR REPLACE FUNCTION public.clear_pos_sync_failure(p_outlet_id uuid, p_source_event_id text)\n RETURNS void\n LANGUAGE plpgsql\n SECURITY DEFINER\n SET search_path TO 'public'\nAS $function$\r\nBEGIN\r\n  IF p_outlet_id IS NULL OR nullif(p_source_event_id, '') IS NULL THEN\r\n    RETURN;\r\n  END IF;\r\n\r\n  DELETE FROM public.pos_sync_failures\r\n  WHERE outlet_id = p_outlet_id\r\n    AND source_event_id = p_source_event_id;\r\nEND;\r\n$function$\n",
          "function_name": "clear_pos_sync_failure",
          "function_schema": "public"
        },
        {
        ...
        {
          "arguments": "p_outlet_id uuid, p_item_id uuid, p_qty_units numeric, p_variant_key text DEFAULT 'base'::text, p_sold_at timestamp with time zone DEFAULT now(), p_context jsonb DEFAULT '{}'::jsonb, p_is_production boolean DEFAULT false, p_warehouse_id uuid DEFAULT NULL::uuid",
          "definition": "CREATE OR REPLACE FUNCTION public.record_outlet_sale(p_outlet_id uuid, p_item_id uuid, p_qty_units numeric, p_variant_key text DEFAULT 'base'::text, p_sold_at timestamp with time zone DEFAULT now(), p_context jsonb DEFAULT '{}'::jsonb, p_is_production boolean DEFAULT false, p_warehouse_id uuid DEFAULT NULL::uuid)\n RETURNS void\n LANGUAGE plpgsql\n SECURITY DEFINER\n SET search_path TO 'public'\nAS $function$\r\nBEGIN\r\n  RETURN;\r\nEND;\r\n$function$\n",
