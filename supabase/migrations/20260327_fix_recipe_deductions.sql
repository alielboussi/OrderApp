-- Fix: allow recipe deductions even when recipe_for_kind does not match catalog item kind.
-- This keeps existing behavior when kinds match, and falls back to any active recipe for the finished item.
