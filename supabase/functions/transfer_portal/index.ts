...
if (!PROJECT_URL) {
  throw new Error('PROJECT_URL env variable is required for transfer portal');
}
if (!ANON_KEY) {
  throw new Error('ANON_KEY (or SUPABASE_ANON_KEY) env variable is required for transfer portal');
}
