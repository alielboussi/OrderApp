...
class SessionStore(private val context: Context) {
  ...
  private val lastTransferFromKey = stringPreferencesKey("last_transfer_from_warehouse")
  private val lastTransferToKey = stringPreferencesKey("last_transfer_to_warehouse")
  ...
  private val lastDamageWarehouseKey = stringPreferencesKey("last_damage_warehouse")
  ...
  suspend fun getLastTransferFromWarehouseId(): String? {
    return context.sessionDataStore.data.first()[lastTransferFromKey]
  }

  suspend fun setLastTransferFromWarehouseId(warehouseId: String) {
    context.sessionDataStore.edit { prefs ->
      prefs[lastTransferFromKey] = warehouseId
    }
  }

  suspend fun getLastTransferToWarehouseId(): String? {
    return context.sessionDataStore.data.first()[lastTransferToKey]
  }

  suspend fun setLastTransferToWarehouseId(warehouseId: String) {
    context.sessionDataStore.edit { prefs ->
      prefs[lastTransferToKey] = warehouseId
    }
  }
  ...
  suspend fun getLastDamageWarehouseId(): String? {
    return context.sessionDataStore.data.first()[lastDamageWarehouseKey]
  }

  suspend fun setLastDamageWarehouseId(warehouseId: String) {
    context.sessionDataStore.edit { prefs ->
      prefs[lastDamageWarehouseKey] = warehouseId
    }
  }
}
