...
const LOCKED_SOURCE_ID = 'c99faeea-d4f1-4ae8-9b10-2c4e9e2f1235';
...
// IMPORTANT: Fuel storeroom scanner behavior mirrors the prior main warehouse scanner.
...
<body data-view="${initialView}" data-auth="true">
      ...
      <form id="purchase-form">
        <div class="purchase-shell">
          ...
          <div class="purchase-actions">
            <a id="purchase-back" class="button button-outline" href="/Fuel_Storeroom_Scanner" role="button">Back to Transfers</a>
      ...
      <form id="damage-form">
        <div class="damage-shell">
          ...
          <div class="damage-actions">
            <a id="damage-back" class="button button-outline" href="/Fuel_Storeroom_Scanner" role="button">Back to Transfers</a>
  ...
  <script>
    ...
    if (!SUPABASE_URL || !SUPABASE_ANON_KEY) {
      ...
      if (window.__fuelAppInitialized) {
        console.debug('Fuel scanner already initialized; skipping duplicate bootstrap');
        return;
      }
      window.__fuelAppInitialized = true;
      ...
      const supabase = supabaseClients.fuelSession ?? getSupabaseClient(SESSION_STORAGE_KEY, {
        auth: {
      ...
      supabaseClients.fuelSession = supabase;

      const passwordVerifier = supabaseClients.fuelPassword ?? getSupabaseClient(PASSWORD_STORAGE_KEY, {
        auth: {
      ...
      supabaseClients.fuelPassword = passwordVerifier;
      ...
      async function notifyTelegram(summary, context = 'transfer') {
        try {
          const response = await fetch('/api/notify-telegram', {
            ...
            body: JSON.stringify({ context, summary, scanner: 'fuel' })
          });
          if (!response.ok) {
            let errorText = '';
            let detailText = '';
