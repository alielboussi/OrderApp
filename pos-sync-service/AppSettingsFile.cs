...
public static class AppSettingsFile
{
    ...
    public static string EnsureJson(string contentRoot)
    {
        ...
        builder.AppendLine("    \"Backend\": \"Firebase\"");
        builder.AppendLine("  },");
        builder.AppendLine("  \"Firebase\": {");
        builder.AppendLine("    \"ProjectId\": \"afterten-portal-system\",");
        builder.AppendLine("    \"CredentialsPath\": \"C:\\\\ProgramData\\\\SCPGT\\\\afterten-firebase-adminsdk.json\"");
        builder.AppendLine("  },");
        ...
        builder.AppendLine("    \"ReclaimProcessedLookbackDays\": 0,");
        builder.AppendLine("    \"ReclaimProcessedBatchSize\": 500,");
        builder.AppendLine("    \"ReclaimProcessedMaxPassesPerCycle\": 30,");
        builder.AppendLine("    \"PostMarkVerifyRetries\": 3,");
        builder.AppendLine("    \"PostMarkVerifyRetryDelayMs\": 250");
        builder.AppendLine("  },");
